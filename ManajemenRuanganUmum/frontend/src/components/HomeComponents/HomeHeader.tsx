export default function HomeHeader() {
  return (
    <div className="mt-10 text-center max-w-2xl px-4 flex flex-col items-center">
      ...
      <h1 className="text-4xl md:text-6xl font-extrabold text-[#111827] mb-8 tracking-tight animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-500 fill-mode-both leading-[1.1]">
        Pilih <span className="text-[#ff6b00]">Akses Layanan</span> Anda
      </h1>
      
      <p className="text-sm md:text-lg text-gray-500 leading-relaxed max-w-xl mx-auto animate-in fade-in zoom-in-95 duration-1000 delay-700 fill-mode-both opacity-70">

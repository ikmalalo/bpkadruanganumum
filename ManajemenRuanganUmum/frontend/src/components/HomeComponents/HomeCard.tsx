...
export default function HomeCard({ 
  ...
  return (
    <div className={`h-full animate-in fade-in slide-in-from-bottom-10 fill-mode-forwards ${delay}`}>
      <div 
        onClick={onClick}
        className="bg-white rounded-[1.5rem] p-4 md:p-6 lg:p-7 shadow-xl border border-gray-100 flex flex-col h-full relative overflow-hidden group scale-100 hover:scale-[1.05] hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#ff6b00]/40 hover:border-[#ff6b00]/40 cursor-pointer transition-all duration-75 ease-out"
      >
        ...
        <div className="flex-grow mb-6 md:mb-8 relative z-10 w-full">
          ...
          <div className="w-6 h-0.5 bg-[#ff6b00] mb-3 rounded-full opacity-40 group-hover:opacity-100 group-hover:w-10 transition-all duration-300" />

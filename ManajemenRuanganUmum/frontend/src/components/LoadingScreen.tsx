...
const LoadingScreen: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[#0d1117] text-white font-poppins select-none transition-opacity duration-1000">
            {/* Top Information */}
            <div className="absolute top-8 left-8 flex flex-col gap-1">
                <span className="text-[10px] tracking-[0.2em] text-gray-500 uppercase font-medium">AUTHORITY</span>
                <span className="text-[12px] font-semibold text-gray-300">BPKAD Samarinda</span>
            </div>
            
            <div className="absolute top-8 right-8 flex flex-col items-end gap-1">
                <span className="text-[10px] tracking-[0.2em] text-gray-500 uppercase font-medium">SECURITY</span>
                <span className="text-[12px] font-semibold text-gray-300 italic">SSL Encrypted</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-12 max-w-sm w-full px-8">
                ...
                <div className="relative group">
                    ...
                    <div className="absolute -inset-4 bg-orange-500/20 rounded-full blur-3xl opacity-50 animate-pulse"></div>
                    
                    <div className="relative w-48 h-48 bg-[#0a0c10] border border-white/5 rounded-2xl flex items-center justify-center shadow-2xl overflow-hidden">
                        <img 
                            src={logo} 
                            alt="Logo BPKAD" 
                ...
                <div className="w-full space-y-6">
                    ...
                    <div className="relative h-[2px] w-full bg-white/5 rounded-full overflow-hidden">
                        ...
                        >
                            <div className="absolute right-0 top-1/2 -translate-y-1/2 w-4 h-4 bg-orange-500 rounded-full blur-md opacity-50"></div>
                        </div>
                    </div>
